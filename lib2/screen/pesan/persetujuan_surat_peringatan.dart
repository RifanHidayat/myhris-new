...
class PersetujuanSuratPeringatan extends StatefulWidget {
  String? title, bulan, tahun;
  PersetujuanSuratPeringatan({Key? key, this.title, this.bulan, this.tahun})
      : super(key: key);
  @override
  _PersetujuanSuratPeringatanState createState() => _PersetujuanSuratPeringatanState();
}

class _PersetujuanSuratPeringatanState extends State<PersetujuanSuratPeringatan>
