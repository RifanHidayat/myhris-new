...
class DetailPersetujuanSuratPeringatan extends StatefulWidget {
...
class _DetailSuratPeringatanState
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(() {
                            ...
                            return tl.isNotEmpty && tl[0]['status'] == 'Approve'
                                ? Container(
                                    decoration: BoxDecoration(
                                      color: Constanst.infoLight1,
                          ...
                          Obx(() {
                            return Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: List.generate(
                                  controller.listStatusPengajuanSPTolak.length,
                                  (index) {
                                var data = controller
                                    .listStatusPengajuanSPTolak[index];
                                return controller.statusPemgajuanSP.value ==
                                        data['value']
                                    ? Padding(
                                        padding: EdgeInsets.only(top: 12),
                                    ...
                                    : InkWell(
                                        onTap: () {
                                          if (controller.searchTl.isEmpty){
                                            controller.statusPemgajuanSP.value =
                                                data['value'].toString();
                                          }else{
                                            if (controller.searchTl[0]
                                                      ['status'] ==
                                                  'Approve' &&
                                              data['value'] ==
                                                  'teguran_lisan') {
                                            UtilsAlert.showToast(
                                                'Karyawan ini saat ini memiliki teguran lisan yang masih aktif, sehingga tidak dapat menerima teguran lisan tambahan.');
                                          } else {
                                            controller.statusPemgajuanSP.value =
                                                data['value'].toString();
                                          }
          ...
          child: CustomDialog(
            ...
            positiveBtnPressed: () {
              ...
              if (controller.detailData[0]['type'] == 'absensi') {
                ...
                print('object 2');
                print(controller.detailData[0]['nomor_ajuan'].toString());
  ...
  void initState() {
    ...
    controller.statusPemgajuanSP.value = "none";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Obx(
          () => Container(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: Text(
                "Detail Persetujuan Surat Peringatan",
                style: GoogleFonts.inter(
      ...
      bottomNavigationBar: Padding(
        ...
        child: Obx(() => controller.detailData[0]['approve_status'] == "Pending"
            ? Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Expanded(
      ...
      body: WillPopScope(
          ...
          child: SafeArea(
            child: Obx(
              () => controller.isLoadingAlasan.value == true
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            controller.listAlasan.isEmpty || controller.listAlasan.every((element) => element['name'].trim().isEmpty)
                                ? SizedBox()
                                : Column(
                                    children: [
                                      TextLabell(
