...
import '../../utils/widget/text_labe.dart';
...
class _ChatPageState extends State<ChatPage> {
 ...
 Timer? _timer;
  ...
  Future<List<dynamic>> _fetchPesanNew() async {

    print('masuk sini history chat new  newnew ');

    var data = await Request(
            url: 'chatting/history',
          params:
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasError) {
                          ...
                          return Center(
                           ...
                           return Center(
                              child:
                                TextLabell(text: "Data history tidak ditemukan",)); 
