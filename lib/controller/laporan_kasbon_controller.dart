...
class LaporanKasbonController extends GetxController {
  ...
  void loadDataKasbonEmployee(emId, bulan, tahun, title) {
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border.all(
                                    width: tempNamaLaporan1.value == "kasbon"
                                        ? 2
                                        : 1,
                                    color: Constanst.onPrimary),
                                borderRadius: BorderRadius.circular(10)),
                            child: tempNamaLaporan1.value == "kasbon"
                                ? Padding(
                                    padding: const EdgeInsets.all(3),
                                    child: Container(
                                      decoration: BoxDecoration(
