...
class DetailPersetujuanAbsensi extends StatefulWidget {
  ...
  DetailPersetujuanAbsensi(
      ...
      : super(key: key);
  @override
  _DetailPersetujuanAbsensiState createState() =>
      _DetailPersetujuanAbsensiState();
}
...
class _DetailPersetujuanAbsensiState extends State<DetailPersetujuanAbsensi> {
  ...
  void initState() {
    ...
    if (controllerGlobal.valuePolaPersetujuan.value.toString() == "1") {
      ...
      if (controller.detailData[0]['approve2_status'] == "Approve" ||
              controller.detailData[0]['leave_status'] == "Rejected") {
                controller.showButton.value = false;
      }
    }
                        ...
                        Text(
                          Constanst.convertDate6(
                              DateFormat("dd-MM-yyyy HH:mm:ss")
                                  .parse(controller.detailData[0]['waktu_dari'])
                                  .toString()),
                          style: GoogleFonts.inter(
                              color: Constanst.fgPrimary,
                              fontWeight: FontWeight.w500,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            Visibility(
                              visible: controller.detailData[0]
                                      ['catatan_masuk'] ==
                                  null,
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.detailData[0]['type'] ==
                                            "absensi"
                                        ? "${controller.detailData[0]['deskripsi_masuk']}"
                                        : "${controller.detailData[0]['catatan_masuk']}",
                                    style: GoogleFonts.inter(
                                        color: Constanst.fgPrimary,
                                        fontWeight: FontWeight.w500,
                                        fontSize: 16),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.detailData[0]['type'] ==
                                            "absensi"
                                        ? "${controller.detailData[0]['deskripsi_keluar']}"
                                        : "${controller.detailData[0]['catatan_keluar']}",
                                    style: GoogleFonts.inter(
                                        color: Constanst.fgPrimary,
                                        fontWeight: FontWeight.w500,
                                        fontSize: 16),
  ...
  Widget fotoWidget({required title}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
        ...
        Text(
          "Foto Absensi ${title[0].toUpperCase()}${title.substring(1)}",
          style: GoogleFonts.inter(
            fontWeight: FontWeight.w400,
            fontSize: 14,
            color: Constanst.fgSecondary,
        ...
        InkWell(
            ...
            child: Text(
              "${controller.detailData[0]['foto_$title']}",
              style: GoogleFonts.inter(
                fontWeight: FontWeight.w500,
                fontSize: 16,
                color: Constanst.infoLight,
