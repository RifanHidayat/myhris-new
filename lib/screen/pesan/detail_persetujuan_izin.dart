...
class DetailPersetujuanIzin extends StatefulWidget {
  ...
  DetailPersetujuanIzin(
      ...
      : super(key: key);
  @override
  _DetailPersetujuanIzinState createState() => _DetailPersetujuanIzinState();
}
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              : Container(
                                  child: Wrap(
                                    children: List.generate(
                                      ...
                                      var nomor = index + 1;
                                      var tanggalConvert =
                                          Constanst.convertDate7(controller
                                              .detailData[0]['date_selected']
                                              .toString()
                                              .split(',')[index]);
                                      var tanggalConvert2 =
                                          Constanst.convertDate5(controller
                                              .detailData[0]['date_selected']
                                              .toString()
                                              .split(',')[index]);
                          ...
                          controller.detailData[0]['input_time'].toString() ==
                                      "0" ||
                                  controller.detailData[0]['input_time'] == null
                              ? const SizedBox()
                              : Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        const SizedBox(height: 4),
                                        controller.detailData[0]['input_time']
                                                    .toString() ==
                                                "2"
                                            ? Text(
