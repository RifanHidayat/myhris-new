...
class DetailPersetujuanTeguranLisan extends StatefulWidget {
  ...
  DetailPersetujuanTeguranLisan(
      ...
      : super(key: key);
  @override
  _DetailTeguranLisanState createState() => _DetailTeguranLisanState();
}
                        ...
                        child: TextButtonWidget(
                          ...
                          onTap: () {
                            ...
                            if (controller.alasanReject.value.text != "") {
                              ...
                              controller.aksiMenyetujuiTeguranLisan('Tolak');
                            } else {
          ...
          child: CustomDialog(
            ...
            positiveBtnPressed: () {
              ...
              if (controller.detailData[0]['type'] == 'absensi') {
                ...
                controller.aksiMenyetujuiTeguranLisan('setuju');
              }
            },
          ),
        );
        ...
        child: Obx(
          () => Container(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: Text(
                "Detail Persetujuan Teguran Lisan",
