...
class PersetujuanWfh extends StatefulWidget {
  String? title, bulan, tahun;
  PersetujuanWfh({Key? key, this.title, this.bulan, this.tahun})
      : super(key: key);
  @override
  _PersetujuanWfhState createState() => _PersetujuanWfhState();
}
