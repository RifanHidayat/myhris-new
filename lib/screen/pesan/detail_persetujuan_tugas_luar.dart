...
class DetailPersetujuanTugasLuar extends StatefulWidget {
  ...
  DetailPersetujuanTugasLuar(
      ...
      : super(key: key);
  @override
  _DetailPersetujuanTugasLuarState createState() =>
      _DetailPersetujuanTugasLuarState();
}

class _DetailPersetujuanTugasLuarState
    extends State<DetailPersetujuanTugasLuar> {
        ...
        child: Obx(
          () => Container(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: Text(
                "Detail Persetujuan ${widget.title}",
