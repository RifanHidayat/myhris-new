...
import 'package:siscom_operasional/controller/laporan_kasbon_controller.dart';
import 'package:siscom_operasional/screen/absen/laporan/laporan_kasbon_detail.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:siscom_operasional/utils/api.dart';
import 'package:siscom_operasional/utils/constans.dart';
import 'package:siscom_operasional/utils/month_year_picker.dart';

class LaporanKasbon extends StatefulWidget {
  String title;
  LaporanKasbon({Key? key, required this.title}) : super(key: key);
  @override
  _LaporanKasbonState createState() => _LaporanKasbonState();
}

class _LaporanKasbonState extends State<LaporanKasbon> {
  var controller = Get.put(LaporanKasbonController());

  @override
  void initState() {
    controller.getDepartemen(1, "");
    controller.title.value = widget.title;
    controller.tempNamaLaporan1.value = "kasbon";
    super.initState();
  }
