...
import 'package:siscom_operasional/screen/absen/laporan/laporan_lembur_detail.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:siscom_operasional/utils/api.dart';
import 'package:siscom_operasional/utils/constans.dart';
import 'package:siscom_operasional/utils/month_year_picker.dart';

class LaporanLembur extends StatefulWidget {
  String title;
  LaporanLembur({Key? key, required this.title}) : super(key: key);
  @override
  _LaporanLemburState createState() => _LaporanLemburState();
}

class _LaporanLemburState extends State<LaporanLembur> {
  ...
  void initState() {
    ...
    controller.tempNamaLaporan1.value = "lembur";
    super.initState();
  }
