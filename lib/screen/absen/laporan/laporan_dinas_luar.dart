...
import 'package:siscom_operasional/controller/laporan_dinas_luar_controller.dart';
import 'package:siscom_operasional/controller/laporan_tidakHadir_controller.dart';
import 'package:siscom_operasional/screen/absen/laporan/laporan_dinas_luar_detail.dart';
import 'package:siscom_operasional/screen/absen/laporan/laporan_semua_pengajuan_detail.dart';
import 'package:siscom_operasional/utils/appbar_widget.dart';
import 'package:siscom_operasional/utils/constans.dart';

class LaporanDinasLuar extends StatefulWidget {
  String title;
  LaporanDinasLuar({Key? key, required this.title}) : super(key: key);
  @override
  _LaporanDinasLuarState createState() => _LaporanDinasLuarState();
}

class _LaporanDinasLuarState extends State<LaporanDinasLuar> {
  var controller = Get.put(LaporanDinasLuarController());
