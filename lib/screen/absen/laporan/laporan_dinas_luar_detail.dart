...
class LaporanDinasLuarDetail extends StatefulWidget {
  String emId, bulan, tahun, full_name, title;
  LaporanDinasLuarDetail(
      {Key? key,
      required this.emId,
      required this.bulan,
      required this.tahun,
      ...
      : super(key: key);
  @override
  _LaporanDinasLuarDetailState createState() => _LaporanDinasLuarDetailState();
}

class _LaporanDinasLuarDetailState extends State<LaporanDinasLuarDetail> {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            flexibleSpace: AppbarMenu1(
              title: "Detail Laporan Dinas Luar",
