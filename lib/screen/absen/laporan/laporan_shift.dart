...
import 'package:siscom_operasional/controller/laporan_shift_controller.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:siscom_operasional/screen/absen/laporan/laporan_shift_detail.dart';
import 'package:siscom_operasional/utils/api.dart';
import 'package:siscom_operasional/utils/app_data.dart';
import 'package:siscom_operasional/utils/constans.dart';
import 'package:siscom_operasional/utils/month_year_picker.dart';

class LaporanShift extends StatefulWidget {
  String title;
  LaporanShift({Key? key, required this.title}) : super(key: key);
  @override
  _LaporanShiftState createState() => _LaporanShiftState();
}

class _LaporanShiftState extends State<LaporanShift> {
  var controller = Get.put(LaporanShiftController());
  ...
  void initState() {
    ...
    controller.tempNamaLaporan1.value = "shift";
