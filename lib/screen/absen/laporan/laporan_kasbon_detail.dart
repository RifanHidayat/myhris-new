...
class LaporanKasbonDetail extends StatefulWidget {
  ...
  LaporanKasbonDetail(
      ...
      : super(key: key);
  @override
  _LaporanKasbonDetailState createState() => _LaporanKasbonDetailState();
}

class _LaporanKasbonDetailState extends State<LaporanKasbonDetail> {
  var controller = Get.put(LaporanKasbonController());

  @override
  void initState() {
    controller.loadDataKasbonEmployee(
