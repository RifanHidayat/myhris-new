...
class LaporanTugasLuarDetail extends StatefulWidget {
  String emId, bulan, tahun, full_name, title, jobTitle, image;
  LaporanTugasLuarDetail(
      {Key? key,
      required this.emId,
      required this.bulan,
      required this.tahun,
      ...
      : super(key: key);
  @override
  _LaporanTugasLuarDetailState createState() => _LaporanTugasLuarDetailState();
}
