...
class LaporanIzin extends StatefulWidget {
  String title;
  LaporanIzin({Key? key, required this.title}) : super(key: key);
  @override
  _LaporanIzinState createState() => _LaporanIzinState();
}

class _LaporanIzinState extends State<LaporanIzin> {
  var controller = Get.put(LaporanIzinController());
