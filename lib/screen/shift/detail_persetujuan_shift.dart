...
class DetailPersetujuanShift extends StatefulWidget {
  ...
  DetailPersetujuanShift(
      ...
      : super(key: key);
  @override
  _DetailPersetujuanShiftState createState() => _DetailPersetujuanShiftState();
}

class _DetailPersetujuanShiftState extends State<DetailPersetujuanShift> {
        ...
        return ScaleTransition(
          ...
          child: CustomDialog(
            ...
            positiveBtnPressed: () {
              ...
              controller.aksiMenyetujuiShift(stringPilihan);
            },
          ),
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    var data = controller.detailData[0];
    var workIdOld = data['work_id_old'];
    var workIdnew = data['work_id_new'];
    var timeInOld = data['time_in_old'];
    var timeInNew = data['time_in_new'];
    var timeOutOld = data['time_out_old'];
    var timeOutNew = data['time_out_new'];
    var nameOld = data['name_old'];
    var nameNew = data['name_new'];
    var nameDelegasi = data['name_delegasi'];
    var tglCurrent = data['dari_tgl'];
    var tglReplace = data['sampai_tgl'];
    print(nameDelegasi);
    var currentSchedule;
    var replaceSchedule;
    if (workIdOld == 0) {
      ...
      currentSchedule =
          '${nameOld} (${Constanst.convertTime(timeInOld)} - ${Constanst.convertTime(timeOutOld)})';
    }
    if (workIdnew == 0) {
      replaceSchedule = 'Dayoff (00:00 - 00:00)';
    } else {
      replaceSchedule =
          '${nameNew} (${Constanst.convertTime(timeInNew)} - ${Constanst.convertTime(timeOutNew)})';
    }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: typeAjuan == "Approve2" || typeAjuan == 'Rejected'
          ? SizedBox()
          : Padding(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Pengajuan ${controller.detailData[0]['type']}",
                                style: GoogleFonts.inter(
                                    fontWeight: FontWeight.w500,
                                    color: Constanst.fgPrimary,
                                    fontSize: 16),
                              ...
                              dateDetail(tglCurrent, 'Date selected'),
                              const SizedBox(height: 4),
                              Padding(
                                padding: const EdgeInsets.only(
                                    top: 12.0, bottom: 12.0),
                              ...
                              dateDetail(tglReplace, 'Date replace selected'),
                              const SizedBox(height: 4),
                              Padding(
                                padding: const EdgeInsets.only(
                                    top: 12.0, bottom: 12.0),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      controller.detailData[0]['nama_divisi'] ?? ''.toString(),
                      style: GoogleFonts.inter(
                          color: Constanst.fgSecondary,
                          fontWeight: FontWeight.w400,
                          fontSize: 14),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        controller.detailData[0]['nomor_ajuan'].toString(),
                        style: GoogleFonts.inter(
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                          color: Constanst.fgPrimary,
