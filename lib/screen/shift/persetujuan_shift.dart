...
class PersetujuanShift extends StatefulWidget {
  String? title, bulan, tahun;
  PersetujuanShift({Key? key, this.title, this.bulan, this.tahun})
      : super(key: key);
  @override
  _PersetujuanShiftState createState() => _PersetujuanShiftState();
}

class _PersetujuanShiftState extends State<PersetujuanShift>
    ...
    return Padding(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            print('ini data listdata shift ${controller.listData}');
