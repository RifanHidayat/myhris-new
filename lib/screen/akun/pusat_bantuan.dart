  ...
  Widget pusatBantuanList() {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          var id = controller.listPusatBantuan.value[index]['idx'].toString();
          var pertanyaan = controller.listPusatBantuan.value[index]['question'].toString();
          var jawaban = controller.listPusatBantuan.value[index]['answered'].toString();
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                       ...
                       controller.listPusatBantuan.value[index]['status']=!controller.listPusatBantuan.value[index]['status'];
                       controller.listPusatBantuan.refresh();
