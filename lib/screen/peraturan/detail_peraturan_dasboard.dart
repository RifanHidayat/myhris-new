...
class DetaillPeraturanDashboard extends StatefulWidget {
  var type;
  var gambar;
  var title;
  var keterangan;
  ...
  @override
  State<DetaillPeraturanDashboard> createState() => _DetaillPeraturanState();
}

class _DetaillPeraturanState extends State<DetaillPeraturanDashboard> {
  var path = '';
  int totalPages = 0;
  int currentPage = 0;
  var isAgreed = false;
