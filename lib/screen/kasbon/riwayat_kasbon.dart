...
import 'package:siscom_operasional/screen/absen/laporan/laporan_kasbon.dart';
...
class Kasbon extends StatefulWidget {
  @override
  _KasbonState createState() => _KasbonState();
}
                ...
                controller.statusFormPencarian.value
                    ...
                    : Row(
                        children: [
                          ...
                          //                 size: 24,
                          //               ),
                          //               onPressed: () => Get.to(LaporanKasbon(
                          //                 title: 'kasbon',
                          //               )),
                          //               // controller.toggleSearch,
                          //             ),
              ...
              children: [
                ...
                Flexible(
                    child: RefreshIndicator(
                        ...
                        child: controller.listKasbon.value.isEmpty
                            ? Center(
                                child: SafeArea(
                                child: Column(
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (controller.valuePolaPersetujuan.value == "1") {
            ...
            status = controller.listKasbon.value[index]['status'] == "Approve"
                ? "Approve 1"
                : controller.listKasbon.value[index]['status'] == "Approve2"
                    ? "Approve 2"
                    : controller.listKasbon.value[index]['status'];
          }
          var namaTypeAjuan = controller.listKasbon.value[index]['type'];
          var alasanReject =
              controller.listKasbon.value[index]['alasan_reject'];
          var approveDate = controller.listKasbon.value[index]['approve_date'];
          var uraian = controller.listKasbon.value[index]['uraian'];
          var approve;
          if (controller.listKasbon.value[index]['approve2_by'] == "" ||
              controller.listKasbon.value[index]['approve2_by'] == "null" ||
              controller.listKasbon.value[index]['approve2_by'] == null) {
            approve = controller.listKasbon.value[index]['approve_by'];
          } else {
            approve = controller.listKasbon.value[index]['approve2_by'];
          }
            ...
            children: [
              ...
              Container(
                ...
                child: InkWell(
                  ...
                  onTap: () => controller.showDetailKasbon(
                      controller.listKasbonAll.value[index],
                      approve,
                      alasanReject),
                  child: Padding(
                    padding: const EdgeInsets.only(
