...
class _DetailLiveTrackingState extends State<DetailLiveTracking> {
  ...
  void initState() {
    ...
    //   locations.add(LatLng(double.parse(lat), double.parse(long)));
    // });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      child: Center(
                        child: FloatingActionButton.extended(
                          ...
                          onPressed: () async {
                            ...
                            print("panelController ${panelController.close()}");
                          },
                          label: Text(
                            "Maps",
                            style: GoogleFonts.inter(
      ...
      body: controllerTracking.isLoadingDetailTracking2.value
          ? const Center(
              child: SizedBox(
                  width: 35,
                  height: 35,
  ...
  Widget _body() {
    // int total =
    //     int.parse(controllerTracking.detailTrackings.value.length.toString()) ~/
    //         2;
