...
class AbsenIstirahatMasukKeluar extends StatefulWidget {
  final status;
  AbsenIstirahatMasukKeluar({super.key, this.status});
  @override
  _AbsenIstirahatMasukKeluarState createState() =>
      _AbsenIstirahatMasukKeluarState();
}

class _AbsenIstirahatMasukKeluarState extends State<AbsenIstirahatMasukKeluar> {
                                ...
                                : Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        controllerDashboard
                                            .widgetButtomSheetAktifCameraIstirahat(
                                                type: 'checkTracking');
