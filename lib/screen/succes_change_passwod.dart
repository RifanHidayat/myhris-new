...
class SuccessCangePasswordPage extends StatefulWidget {
  const SuccessCangePasswordPage({super.key});

  @override
  State<SuccessCangePasswordPage> createState() => _SuccessCangePasswordPageState();
}

class _SuccessCangePasswordPageState extends State<SuccessCangePasswordPage> {
  @override
