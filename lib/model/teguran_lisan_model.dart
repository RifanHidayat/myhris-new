...
class TeguranLisanModel {
  ...
  factory TeguranLisanModel.fromMap(Map<String, dynamic> map) {
    return TeguranLisanModel(
        alasan: map['alasan'],
  ...
  static List<TeguranLisanModel> fromJsonToList(List data) {
    return List<TeguranLisanModel>.from(data.map(
      (item) => TeguranLisanModel.fromMap(item),
    ));
  }
}
